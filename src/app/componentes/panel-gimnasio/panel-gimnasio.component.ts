...
@Component({
  selector: 'app-panel-gimnasio',
  templateUrl: './panel-gimnasio.component.html',
  styleUrls: ['./panel-gimnasio.component.css']
})
export class PanelGimnasioComponent implements OnInit {
  opcionMenu:any;
  nombreAdmin: string = '';
  mostrarAvatar = false;
  hide = true;
