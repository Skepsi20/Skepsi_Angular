...
export class FaqComponent implements OnInit {
  ...
  imagenCuatroSeleccionada = false;
  ...
  mostrarTexto(texto:number){
    switch(texto){
      case 1: this.imagenUnoSeleccionada = !this.imagenUnoSeleccionada; break;
      case 2: this.imagenDosSeleccionada = !this.imagenDosSeleccionada; break;
      case 3: this.imagenTresSeleccionada = !this.imagenTresSeleccionada; break;
      case 4: this.imagenCuatroSeleccionada = !this.imagenCuatroSeleccionada; break;
    }
  }
